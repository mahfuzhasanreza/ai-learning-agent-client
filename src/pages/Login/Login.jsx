  ...
  const particles = Array.from({ length: 20 }, (_, i) => (
    ...
    >
      <div className={`w-2 h-2 rounded-full ${
        i % 3 === 0 ? 'bg-yellow-300' : i % 3 === 1 ? 'bg-pink-300' : 'bg-blue-300'
      }`} />
    </div>
  ));
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
            <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                    <Mail className={`h-5 w-5 transition-all duration-300 ${
                      focusedField === 'email' ? 'text-purple-300 scale-110' : 'text-gray-400'
                    }`} />
                  </div>
                  <input
                    type="email"
                    ...
                    className={`relative w-full pl-12 pr-4 py-4 bg-white/10 border backdrop-blur-sm rounded-2xl focus:ring-2 focus:ring-purple-400 focus:border-transparent outline-none transition-all duration-300 text-white placeholder-gray-400 ${
                      focusedField === 'email' 
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                    <Lock className={`h-5 w-5 transition-all duration-300 ${
                      focusedField === 'password' ? 'text-purple-300 scale-110' : 'text-gray-400'
                    }`} />
                  </div>
                  <input
                    ...
                    onBlur={() => setFocusedField('')}
                    className={`relative w-full pl-12 pr-14 py-4 bg-white/10 border backdrop-blur-sm rounded-2xl focus:ring-2 focus:ring-purple-400 focus:border-transparent outline-none transition-all duration-300 text-white placeholder-gray-400 ${
                      focusedField === 'password' 
                        ? 'border-purple-400/50 shadow-lg shadow-purple-500/25 bg-white/15' 
                        : 'border-white/20 hover:border-white/30'
                    }`}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`relative w-full py-4 px-6 rounded-2xl font-semibold text-lg transition-all duration-300 transform overflow-hidden group ${
                  isLoading
