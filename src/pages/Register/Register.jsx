        ...
        <div className="w-full max-w-md xl:max-w-lg 2xl:max-w-xl space-y-8 xl:space-y-10 xl:bg-white xl:p-12 xl:rounded-2xl xl:shadow-2xl xl:border xl:border-gray-100">
          ...
          <div className="space-y-8 xl:space-y-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                {['student', 'teacher'].map((type) => (
                  <button
                    ...
                    className={`p-4 xl:p-5 rounded-xl xl:rounded-2xl border-2 transition-all duration-200 transform hover:-translate-y-0.5 ${
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 xl:pl-5 flex items-center pointer-events-none">
                    <User className={`h-6 w-6 xl:h-7 xl:w-7 transition-colors duration-200 ${
                  ...
                  <input
                    ...
                    className={`w-full pl-12 xl:pl-14 pr-4 xl:pr-6 py-4 xl:py-5 border rounded-xl xl:rounded-2xl text-base xl:text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all duration-200 ${
                      focusedField === 'firstName' ? 'border-emerald-500 shadow-lg' : 'border-gray-300'
                    }`}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocusedField('')}
                    className={`w-full pl-12 xl:pl-14 pr-4 xl:pr-6 py-4 xl:py-5 border rounded-xl xl:rounded-2xl text-base xl:text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all duration-200 ${
                      focusedField === 'lastName' ? 'border-emerald-500 shadow-lg' : 'border-gray-300'
                    }`}
            ...
            <div className="relative">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 xl:pl-5 flex items-center pointer-events-none">
                  <Mail className={`h-6 w-6 xl:h-7 xl:w-7 transition-colors duration-200 ${
                ...
                <input
                  ...
                  onBlur={() => setFocusedField('')}
                  className={`w-full pl-12 xl:pl-14 pr-4 xl:pr-6 py-4 xl:py-5 border rounded-xl xl:rounded-2xl text-base xl:text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all duration-200 ${
                    focusedField === 'email' ? 'border-emerald-500 shadow-lg' : 'border-gray-300'
                  }`}
            ...
            <div className="relative">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 xl:pl-5 flex items-center pointer-events-none">
                  <Lock className={`h-6 w-6 xl:h-7 xl:w-7 transition-colors duration-200 ${
                ...
                <input
                  ...
                  onBlur={() => setFocusedField('')}
                  className={`w-full pl-12 xl:pl-14 pr-14 xl:pr-16 py-4 xl:py-5 border rounded-xl xl:rounded-2xl text-base xl:text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all duration-200 ${
                    focusedField === 'password' ? 'border-emerald-500 shadow-lg' : 'border-gray-300'
                  }`}
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField('')}
                  className={`w-full pl-12 xl:pl-14 pr-14 xl:pr-16 py-4 xl:py-5 border rounded-xl xl:rounded-2xl text-base xl:text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all duration-200 ${
                    focusedField === 'confirmPassword' ? 'border-emerald-500 shadow-lg' : 'border-gray-300'
                  } ${
            ...
            <button
              ...
              className={`w-full py-4 xl:py-5 px-6 rounded-xl xl:rounded-2xl text-lg xl:text-xl font-medium transition-all duration-200 transform ${
